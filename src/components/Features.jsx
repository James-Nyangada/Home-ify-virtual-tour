  ...
  <section className="bg-black pb-52">
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        To revolutionize the way businesses showcase their spaces and ideas. We aim to blend creativity with innovation technology, delivering high quality media that captivates, engages and ultimately, converts.
        </p>
      </div>
